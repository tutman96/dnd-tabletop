			...
			<Box sx={{
				...
				<Card sx={{
					...
					<CardContent>
						...
						<Typography variant="overline" fontSize={48} sx={{fonFamily: 'monospace'}}>{webrtcChannel?.sessionId}</Typography>
						<br/>
						<Typography variant="caption" sx={{opacity:0.6}}>Navigate to the scene editor menu's display settings to connect to this display.</Typography>
					</CardContent>
				</Card>
			</Box>
		)
